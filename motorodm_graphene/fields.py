...
class MotorOdmConnectionField(ConnectionField):
    ...
    def type(self):
        ...
        assert issubclass(
            _type, MotorOdmObjectType), "MotorOdmConnectionField only accepts MotorOdmObjectType types"
        ...
        if args:
            ...
            for arg_name, arg in args.copy().items():
                if arg_name in reference_fields:
                    ...
                    reference_obj = reference_model.document_type_obj.objects(
                        pk=pk).get()
